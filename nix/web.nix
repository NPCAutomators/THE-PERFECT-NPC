# nix/web.nix — Zorin Web Dashboard (Vite/React) frontend build
{ pkgs, zorinNpmLib, ... }:
let
  # @zorin/shared ships as a file: workspace dep of web, so its source
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../zorin_cli/web_dist for the

      ...
      let
        ...
        excludedDirs =
          ...
          ++ [
            ...
            "nix"
            # Skills are shipped via ZORIN_BUNDLED_SKILLS /
            # ZORIN_OPTIONAL_SKILLS (see zorin-agent.nix), not via the
...
in
{
  ...
  #
  # Usage:
  #   npm = zorinNpmLib.mkNpmPassthru { dirs = [ "ui-tui" ]; };
  #   npm = zorinNpmLib.mkNpmPassthru { dirs = [ "apps/desktop" "apps/shared" ]; };

# nix/overlays.nix — Expose pkgs.zorin-agent for external NixOS configs
#
...
# `pkgs.zorin-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    zorin-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}

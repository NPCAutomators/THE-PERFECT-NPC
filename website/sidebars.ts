...
const sidebars: SidebarsConfig = {
  docs: [
    ...
    },
    {
      ...
      items: [
        'integrations/index',
        'integrations/npcautomators-portal',
    ...
    },
    {
      ...
      items: [
        ...
        'guides/run-zorin-with-npcautomators-portal',
        'guides/tips',
        'guides/local-llm-on-mac',
        'guides/daily-briefing-bot',
        'guides/team-telegram-assistant',
        'guides/python-library',
        'guides/use-mcp-with-zorin',
        'guides/use-soul-with-zorin',
        'guides/use-voice-mode-with-zorin',

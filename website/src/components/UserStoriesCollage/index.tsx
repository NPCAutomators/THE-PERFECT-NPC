  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the ZORIN community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Zorin &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Zorin?{' '}
        <a
          href="https://github.com/NPCAutomators/AGENT-ZORIN/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/NPCAutomators" target="_blank" rel="noopener noreferrer">
          NPCAUTOMATORS Discord
        </a>{' '}

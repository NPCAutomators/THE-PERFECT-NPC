...
const config: Config = {
  ...
  url: 'https://zorin-agent.npcautomators.com',
  baseUrl: '/docs/',

  organizationName: 'NPCAutomators',
  projectName: 'AGENT-ZORIN',
      ...
      '@docusaurus/plugin-client-redirects',
      {
        ...
        redirects: [
          ...
          },
          {
            ...
            from: '/guides/build-a-zorin-plugin',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/NPCAutomators/AGENT-ZORIN/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'img/zorin-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/NPCAutomators/AGENT-ZORIN/',
          label: 'Download',
          position: 'left',
        },
        {
        ...
        {
          href: 'https://discord.gg/NPCAutomators',
          label: 'Discord',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https://discord.gg/NPCAutomators' },
            { label: 'GitHub Issues', href: 'https://github.com/NPCAutomators/AGENT-ZORIN/issues' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'Desktop Download', href: 'https://github.com/NPCAutomators/AGENT-ZORIN/' },
            { label: 'GitHub', href: 'https://github.com/NPCAutomators/AGENT-ZORIN' },
            { label: 'NPCAUTOMATORS', href: 'https://npcautomators.com' },
          ],
        },
      ],
      copyright: `Built by <a href="https://npcautomators.com">NPCAUTOMATORS</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {

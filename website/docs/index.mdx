...
slug: /
sidebar_position: 0
title: "ZORIN Documentation"
description: "The self-improving AI agent built by NPCAUTOMATORS. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [NPCAUTOMATORS](https://npcautomators.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `zorin setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [NPCAUTOMATORS Portal](/integrations/npcautomators-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Zorin safely  |
| 🧭 **[Use MCP with Zorin](/guides/use-mcp-with-zorin)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Zorin](/guides/use-voice-mode-with-zorin)** | Hands-on setup and usage patterns for Zorin voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Zorin' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Zorin                              |
...
- **Built by model trainers** — Created by [NPCAUTOMATORS](https://npcautomators.com), the lab behind Zorin, Nomos, and Psyche. Works with [NPCAUTOMATORS Portal](https://portal.npcautomators.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS — one subscription via [NPCAUTOMATORS Portal](/integrations/npcautomators-portal) bundles all of them
- **MCP support** — Connect to any MCP server for extended tool capabilities
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [NPCAUTOMATORS](https://npcautomators.com) — the lab behind Zorin, Nomos, and Psyche models

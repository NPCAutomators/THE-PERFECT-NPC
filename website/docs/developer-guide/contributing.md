...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to ZORIN — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to ZORIN! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying Zorin core? Start with [Build a Zorin Plugin](../developer-guide/plugins/index.md)
- Building a new built-in core tool for Zorin itself? Start with [Adding Tools](./adding-tools.md)
...
You can also run a fully isolated Zorin instance (throwaway ZORIN_HOME, separate Electron
userData, distinct Electron app name to avoid the single-instance lock):

```bash
scripts/dev-sandbox.sh python -m zorin_cli.main
scripts/dev-sandbox.sh --persistent python -m zorin_cli.main desktop  # state survives restarts, but lives in the worktree :)
```
...
echo 'OPENROUTER_API_KEY=sk-or-v1-your-key' >> ~/.zorin/.env
```
...
- **Profile-safe paths**: Never hardcode `~/.zorin` — use `get_zorin_home()` from `zorin_constants` for code paths and `display_zorin_home()` for user-facing messages. See [AGENTS.md](https://github.com/NPCAutomators/AGENT-ZORIN/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
- **Discord**: [discord.gg/NPCAutomators](https://discord.gg/NPCAutomators)
- **GitHub Discussions**: For design proposals and architecture discussions
- **Skills Hub**: Upload specialized skills and share with the community

## License

By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/NPCAutomators/AGENT-ZORIN/blob/main/LICENSE).

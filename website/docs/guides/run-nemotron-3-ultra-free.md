---
sidebar_position: 0
title: "Run Nemotron 3 Ultra free in ZORIN"
description: "Try NVIDIA Nemotron 3 Ultra on NPCAUTOMATORS Portal — free June 4–18 — with day 0 support in ZORIN"
---

# Run Nemotron 3 Ultra free in ZORIN

NPCAUTOMATORS has been inducted into the **Nemotron Coalition** of leading AI labs working with **NVIDIA** to advance open frontier foundation models. In honor of this, we've partnered with **Nebius** to provide **Nemotron 3 Ultra** free on [NPCAUTOMATORS Portal](https://portal.npcautomators.com) for two weeks (**June 4th – June 18th**). Follow the instructions below to try the model in your ZORIN today.
...
[Download the Zorin Desktop installer](https://github.com/NPCAutomators/AGENT-ZORIN/) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).

### 2. Connect NPCAUTOMATORS Portal

When the app opens, you'll see a "Let's get you set up" screen. Click **NPCAUTOMATORS Portal** (marked **Recommended**). Your browser opens — create a [NPCAUTOMATORS Portal](https://portal.npcautomators.com) account (or sign in), choose the **Free** plan, and authorize Zorin. The app connects automatically.
...
Prefer to review first? Download [`install.sh`](https://raw.githubusercontent.com/NPCAutomators/AGENT-ZORIN/main/scripts/install.sh), inspect it, then run it.
...
Select **Quick Setup**. Zorin opens a browser tab and waits for you to finish the next steps.

### 3. Create a NPCAUTOMATORS Portal account

In the browser, create a [NPCAUTOMATORS Portal](https://portal.npcautomators.com) account (or sign in) and choose the **Free** plan.

### 4. Connect your account

When prompted to connect your account to ZORIN, click **Connect**. You'll see a confirmation once it's linked.
...
- **Don't see the model in the list?** Make sure you finished the NPCAUTOMATORS Portal connection and that you're on the **Free** plan. In the CLI, `zorin portal info` confirms you're logged in and routing through NpcAutomators.
...
- **[Run ZORIN with NPCAUTOMATORS Portal](/guides/run-zorin-with-npcautomators-portal)** — Full Portal walkthrough: models, Tool Gateway, and verification
- **[NPCAUTOMATORS Portal integration](/integrations/npcautomators-portal)** — What's in the subscription

...
| | |
|---|---|
| Source | Optional — install with `zorin skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), ZORIN |
| License | MIT |
...
Helper script path: `~/.zorin/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.zorin/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.zorin/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.zorin/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```

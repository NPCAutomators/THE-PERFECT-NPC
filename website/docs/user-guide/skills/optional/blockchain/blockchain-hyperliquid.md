...
| | |
|---|---|
| Source | Optional — install with `zorin skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), ZORIN |
| License | MIT |
...
The script reads `${ZORIN_HOME:-~/.zorin}/.env` for two optional defaults:
...
Helper script: `~/.zorin/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.zorin/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${ZORIN_HOME:-~/.zorin}/.env`.
...
```bash
python3 ~/.zorin/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.zorin/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \

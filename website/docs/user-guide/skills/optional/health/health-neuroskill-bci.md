...
| | |
|---|---|
| Source | Optional — install with `zorin skills install official/health/neuroskill-bci` |
...
Connect Zorin to a running [NeuroSkill](https://neuroskill.com/) instance to read

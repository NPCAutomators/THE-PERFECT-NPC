...
| | |
|---|---|
| Source | Optional — install with `zorin skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), ZORIN |
| License | MIT |
...
```
SCRIPT=~/.zorin/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.zorin/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```

...
| | |
|---|---|
| Source | Optional — install with `zorin skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.zorin/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.zorin/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Zorin installs package this)

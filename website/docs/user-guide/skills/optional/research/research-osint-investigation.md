...
| | |
|---|---|
| Source | Optional — install with `zorin skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | ZORIN (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $ZORIN_OSINT_CACHE/icij/ (default: ~/.cache/zorin-osint/icij/).
...
# Set ZORIN_OSINT_UA=your-app/1.0 (your@email) to identify yourself

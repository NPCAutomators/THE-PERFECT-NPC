...
| | |
|---|---|
| Source | Optional — install with `zorin skills install official/research/qmd` |
...
ZORIN via the native MCP client. This is the preferred
...
Then configure ZORIN to connect via HTTP:

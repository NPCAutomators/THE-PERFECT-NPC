/**
 * Zorin desktop plugin template. Save as:
 *   <zorin home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <zorin home> is ~/.zorin by default, or ~/.zorin/profiles/<name>
 * when running a named profile (`zorin -p <name>`). Run `zorin doctor` (or
 ...
 * Only these imports resolve: @zorin/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@zorin/plugin-sdk'

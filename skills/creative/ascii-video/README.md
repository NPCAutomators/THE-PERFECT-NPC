...
Built for [ZORIN](https://github.com/NPCAutomators/AGENT-ZORIN). Usable in any coding agent. Canonical source lives here; synced to [`NPCAutomators/AGENT-ZORIN/skills/creative/ascii-video`](https://github.com/NPCAutomators/AGENT-ZORIN/tree/main/skills/creative/ascii-video) via PR.

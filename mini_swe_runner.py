#!/usr/bin/env python3
"""
SWE Runner with Zorin Trajectory Format

A runner that uses Zorin-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Zorin-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Zorin-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Zorin format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Zorin-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Zorin-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Zorin Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Zorin-Agent's built-in execution environments
    and outputs trajectories in Zorin-Agent format.
    """
    ...
    def _convert_to_zorin_format(
        ...
        """
        Convert internal message format to Zorin trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Zorin trajectory format
        trajectory = self._convert_to_zorin_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Zorin trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Zorin Trajectory Format")
    print("=" * 60)

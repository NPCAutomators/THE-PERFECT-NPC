...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Zorin's web-provider config and
        ...
        # native search engine for xAI sessions instead of Zorin's
        # configured web provider (Tavily/etc.), and those results bypass
        # Zorin's tool-trace / citation plumbing (they arrive baked into the

...
_OFFICIAL_DOCS_PRICING: Dict[tuple[str, str], PricingEntry] = {
    ...
    # Fireworks AI — serverless pricing for the models zorin typically routes
...
def resolve_billing_route(
    ...
    if provider_name == "npcautomators" or base_url_host_matches(base_url or "", "inference-api.npcautomators.com"):
        return BillingRoute(provider="npcautomators", model=model, base_url=base_url or _NPCAUTOMATORS_DEFAULT_BASE_URL, billing_mode="official_models_api")

...
#
# See: https://github.com/NPCAutomators/AGENT-ZORIN/issues/27344
...
def _classify_by_status(
    ...
    *,
    ...
    if status_code == 401:
        ...
        # provider-specific refresh (Codex, Anthropic, NpcAutomators) run before
    ...
    if status_code == 404:
        # NpcAutomators API currently surfaces HA/NAS credit depletion as a paid model

"""Vertex AI (Google Cloud) adapter for ZORIN.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Zorin to use Gemini models via Google Cloud with
...
# who installed plain `zorin-agent` and only later selected a Gemini model.
try:

...
anthropic, npcautomators, copilot), a long-context compression restart, a length-
...
class TurnRetryState:
    ...
    npcautomators_auth_retry_attempted: bool = False
    npcautomators_paid_entitlement_refresh_attempted: bool = False

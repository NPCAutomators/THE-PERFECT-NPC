...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``zorin logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # Zorin only initiates compaction in "zorin" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Zorin preflight compression for codex app-server "
                "(mode=%s); Zorin will not start thread compaction here.",

...
Hooks are discovered from ~/.zorin/hooks/ directories, each containing:
...
HOOKS_DIR = get_zorin_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"zorin_hook_{hook_name}"

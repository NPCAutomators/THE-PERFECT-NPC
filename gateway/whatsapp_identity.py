...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$ZORIN_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_zorin_dir("platforms/whatsapp/session", "whatsapp/session")

...
Data file: $ZORIN_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ZORIN_HOME = Path(os.environ.get("ZORIN_HOME", Path.home() / ".zorin"))
DATA_DIR = _ZORIN_HOME / "skills" / "productivity" / "memento-flashcards" / "data"

"""Tests for the specifier module + `zorin kanban specify` CLI surface.
...
from zorin_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `zorin kanban …` argparse surface directly."""

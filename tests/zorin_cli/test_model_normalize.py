"""Tests for zorin_cli.model_normalize — provider-aware model name normalization.
...
class TestAggregatorProviders:
    ...
    def test_npcautomators_prepends_vendor(self):
        result = normalize_model_for_provider("gpt-5.4", "npcautomators")
...
class TestDeepseekVSeriesPassThrough:
    ...
    aggregators (NpcAutomators portal, OpenRouter via DeepInfra) routes to V3 —

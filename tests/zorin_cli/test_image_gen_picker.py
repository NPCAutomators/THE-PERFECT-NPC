...
class TestConfigWriting:
    ...
    def test_plugin_provider_active_overrides_managed_npcautomators_active_label(self, monkeypatch):
        from zorin_cli import tools_config
        ...
        monkeypatch.setattr(
            ...
            lambda config, **kwargs: SimpleNamespace(
                features={"image_gen": SimpleNamespace(managed_by_npcautomators=True)}
            ),
        )
        ...
        assert tools_config._is_provider_active(npcautomators_row, config) is False

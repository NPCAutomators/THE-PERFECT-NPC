...
The main() function in zorin_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `zorin -c model`
...
def _build_parser():
    """Build a minimal replica of the zorin top-level parser."""

"""Tests for `zorin curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import zorin_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated ZORIN_HOME with real agent-created skills on disk."""
    home = tmp_path / ".zorin"
    skills = home / "skills"
    ...
    from zorin_cli import curator as curator_cli

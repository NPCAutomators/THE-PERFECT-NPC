...
class TestTencentTokenhubAliases:
    ...
    def test_normalize_provider_models_py(self):
        from zorin_cli.models import normalize_provider
    ...
    def test_normalize_provider_providers_py(self):
        from zorin_cli.providers import normalize_provider
        assert normalize_provider("tencent") == "tencent-tokenhub"
        assert normalize_provider("tokenhub") == "tencent-tokenhub"
        assert normalize_provider("tencent-cloud") == "tencent-tokenhub"
        assert normalize_provider("tencentmaas") == "tencent-tokenhub"
...
class TestTencentTokenhubModelCatalog:
    ...
    def test_default_model(self):
        from zorin_cli.models import get_default_model_for_provider
        assert get_default_model_for_provider("tencent-tokenhub") == "hy3-preview"


# =============================================================================
# CANONICAL_PROVIDERS (zorin model picker)
# =============================================================================
...
# =============================================================================
# OpenRouter / NPCAUTOMATORS Portal curated lists
# =============================================================================


class TestTencentInOpenRouterAndNpcAutomators:
    """tencent/hy3:free and tencent/hy3 should appear in OpenRouter and NpcAutomators curated lists."""
    ...
    def test_in_npcautomators_provider_models(self):
        from zorin_cli.models import _PROVIDER_MODELS
        assert "tencent/hy3" in _PROVIDER_MODELS["npcautomators"]
...
class TestTencentTokenhubNormalization:
    ...
    def test_not_in_matching_prefix_strip_set(self):
        ...
        from zorin_cli.model_normalize import _MATCHING_PREFIX_STRIP_PROVIDERS
    ...
    def test_not_in_lowercase_providers(self):
        ...
        from zorin_cli.model_normalize import _LOWERCASE_MODEL_PROVIDERS
...
class TestTencentTokenhubProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "tencent-tokenhub" in ZORIN_OVERLAYS
        overlay = ZORIN_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubDoctor:
    """Verify zorin doctor recognizes Tencent TokenHub env vars."""
...
class TestTencentTokenhubAgentInit:
    ...
    def test_api_mode_is_chat_completions(self):
        from zorin_cli.providers import ZORIN_OVERLAYS, TRANSPORT_TO_API_MODE
        overlay = ZORIN_OVERLAYS["tencent-tokenhub"]
...
class TestTencentTokenhubCLIDispatch:
    ...
    def test_in_api_key_provider_tuple(self):
        ...
        so ``zorin model`` routes it through the generic api_key_provider flow.
        """
        import inspect
        from zorin_cli import main as main_mod
...
class TestTencentTokenhubApiMode:
    ...
    def test_determine_api_mode_direct(self):
        from zorin_cli.providers import determine_api_mode
...
class TestTencentTokenhubKnownProviderNames:
    ...
    def test_canonical_id_known(self):
        from zorin_cli.models import _KNOWN_PROVIDER_NAMES

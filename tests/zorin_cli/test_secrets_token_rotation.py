"""Tests for `zorin secrets bitwarden token` / `zorin secrets onepassword token`.
...
from zorin_cli import onepassword_secrets_cli as op_cli
from zorin_cli import secrets_cli as bw_cli

...
class TestXiaomiCredentials:
    ...
    def test_resolve_credentials_reads_home_external_secret_scope(
        ...
        from zorin_cli import env_loader
...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from zorin_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in ZORIN_OVERLAYS
        overlay = ZORIN_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify zorin doctor recognizes Xiaomi env vars."""

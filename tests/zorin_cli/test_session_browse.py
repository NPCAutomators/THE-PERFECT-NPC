"""Tests for the interactive session browser (`zorin sessions browse`).
...
from zorin_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """zorin sessions browse should be parseable."""

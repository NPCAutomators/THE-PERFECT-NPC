...
def test_prompt_toolkit_model_picker_defers_confirmation_off_key_handler(monkeypatch):
    ...
    self_ = SimpleNamespace(
        ...
        _model_picker_state={
            "stage": "model",
            "provider_data": {"slug": "npcautomators"},
    ...
    self_._close_model_picker = _bound(cli_mod.ZorinCLI._close_model_picker, self_)
    ...
    _bound(cli_mod.ZorinCLI._handle_model_picker_selection, self_)(persist_global=True)

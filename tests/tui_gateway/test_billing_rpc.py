...
def test_billing_step_up_granted(monkeypatch):
    ...
    monkeypatch.setattr(auth, "step_up_npcautomators_billing_scope", lambda **kw: True)
...
def test_billing_step_up_downscoped(monkeypatch):
    ...
    monkeypatch.setattr(auth, "step_up_npcautomators_billing_scope", lambda **kw: False)
    res = _call("billing.step_up", {})

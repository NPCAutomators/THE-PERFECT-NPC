...
class TestResolveRuntimeAgentKwargsAuthFallback:
    ...
    def test_auth_error_tries_fallback(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("gateway.run._zorin_home", tmp_path)
    ...
    def test_legacy_fallback_is_appended_after_fallback_providers(self, tmp_path, monkeypatch):
        ...
        def _mock_resolve(**kwargs):
            ...
            return {
                ...
                "base_url": "https://portal.npcautomators.com/v1",
                "provider": "npcautomators",
        ...
        assert calls == ["openrouter", "npcautomators"]
        assert result["provider"] == "npcautomators"
        assert result["model"] == "Zorin-4"

"""Tests for _setup_feishu() in zorin_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("zorin_cli.config.save_env_value", side_effect=mock_save), \
         patch("zorin_cli.config.get_env_value", side_effect=mock_get), \
         patch("zorin_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("zorin_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("zorin_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("zorin_cli.cli_output.print_header"), \
         patch("zorin_cli.cli_output.print_info"), \
         patch("zorin_cli.cli_output.print_success"), \
         patch("zorin_cli.cli_output.print_warning"), \
         patch("zorin_cli.cli_output.print_error"), \

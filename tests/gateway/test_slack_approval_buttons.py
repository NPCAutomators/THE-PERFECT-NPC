...
class TestSlackExecApproval:
    ...
    async def test_sends_blocks_with_buttons(self):
        ...
        assert "zorin_approve_once" in action_ids
        assert "zorin_approve_session" in action_ids
        assert "zorin_approve_always" in action_ids
        assert "zorin_deny" in action_ids
...
class TestSlackApprovalAction:
    ...
    async def test_deny_action(self):
        ...
        action = {"action_id": "zorin_deny", "value": "session-key"}
    ...
    async def test_truncates_inflated_original_text(self):
        ...
        action = {"action_id": "zorin_approve_once", "value": "session-key"}

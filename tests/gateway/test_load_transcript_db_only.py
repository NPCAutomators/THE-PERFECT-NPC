...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.zorin/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at zorin_state import time, before pytest's ZORIN_HOME monkeypatch
    fires — the autouse fixture's ZORIN_HOME override doesn't help here.)
    """
    import zorin_state

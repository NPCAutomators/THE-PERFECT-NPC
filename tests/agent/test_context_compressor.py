...
class TestAuthFailureAborts:
    ...
    Real incident: a npcautomators token pointed at a stale staging inference URL
    ...
    def test_missing_provider_api_key_preserves_original_messages(self):
        ...
        err = RuntimeError(
            ...
            "to a different provider with zorin model."
        )
        with patch(
...
class TestSummaryFallbackToMainModel:
    ...
    def test_unknown_error_falls_back_to_main_and_succeeds(self):
        ...
        # A 400 from OpenRouter / NpcAutomators portal with an opaque message — does
...
class TestTruncateToolCallArgsJson:
    ...
    def test_shrunken_args_remain_valid_json(self):
        ...
        original = _json.dumps({
            "path": "~/.zorin/skills/shopping/browser-setup-notes.md",
        ...
        assert parsed["path"] == "~/.zorin/skills/shopping/browser-setup-notes.md"

...
def test_zorin_meta_tolerates_non_dict():
    assert learning_graph._zorin_meta({"metadata": "junk"}) == {}
    assert learning_graph._zorin_meta({"metadata": {"zorin": "junk"}}) == {}
    assert learning_graph._zorin_meta({"metadata": {"zorin": {"category": "x"}}}) == {"category": "x"}

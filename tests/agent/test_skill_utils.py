...
def test_metadata_as_dict_with_zorin():
    """Normal case: metadata is a dict containing zorin keys."""
    frontmatter = {
        "metadata": {
            "zorin": {
...
class TestParseFrontmatterBOM:
    ...
    def test_bom_config_vars_preserved(self):
        # metadata.zorin.config drives secure setup-on-load; it must survive

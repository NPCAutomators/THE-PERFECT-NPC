...
thinking phase.  Zorin's default cloud-stream stale detector
(``ZORIN_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``ZORIN_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the

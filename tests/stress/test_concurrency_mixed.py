...
def worker_loop(worker_id: int, zorin_home: str, result_file: str) -> None:
...
def reclaimer_loop(zorin_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="zorin_mixed_stress_")
    print(f"ZORIN_HOME = {home}")

...
5. Recovery is skipped for aggregator providers (OpenRouter, NpcAutomators)
...
class TestTryRecoverPrimaryTransport:
    ...
    def test_skipped_for_npcautomators_provider(self):
        agent = _make_agent(provider="npcautomators", base_url="https://inference.npcautomators.npcautomators.com/v1")
        error = _make_transport_error("ReadTimeout")

"""Session <-> workspace grouping key (zorin_state.workspace_key).

The key is what `zorin sessions list --workspace` groups/filters on. It is a
...
from zorin_state import workspace_key

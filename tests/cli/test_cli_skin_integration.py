...
from cli import ZorinCLI, _rich_text_from_ansi
from zorin_cli.skin_engine import get_active_skin, set_active_skin
...
class TestCliSkinPromptIntegration:
    ...
    def test_narrow_terminals_compact_voice_prompt_fragments(self):
        ...
        with patch.object(ZorinCLI, "_get_tui_terminal_width", return_value=50):
    ...
    def test_icon_only_skin_symbol_still_visible_in_special_states(self):
        ...
        with patch("zorin_cli.skin_engine.get_active_prompt_symbol", return_value="⚔ "):
            assert cli._get_tui_prompt_fragments() == [("class:sudo-prompt", "🔑 ⚔ ")]

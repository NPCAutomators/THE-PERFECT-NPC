...
we don't pay the full ZorinCLI.__init__ cost; a synthetic spritesheet exercises
...
def boba_like(tmp_path, monkeypatch):
    """Install a synthetic pet into a temp ZORIN_HOME and return its slug."""
...
def _make_cli():
    ...
    # Transient-beat + reasoning state (set by ZorinCLI.__init__ in production).
    cli_obj._pet_event = ""

...
The unit tests in tests/zorin_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned zorin-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/zorin")
from zorin_cli.service_manager import S6ServiceManager

...
Only included in the zorin-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Zorin-Agent (https://github.com/NPCAutomators/AGENT-ZORIN)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_zorin_home() / "cache" / "discord_capabilities.json"

...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of NPCAutomators/AGENT-ZORIN#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of NPCAutomators/AGENT-ZORIN#47072).
...
class ActionResult:
    ...
    verify → escalate ladder (NPCAutomators/AGENT-ZORIN#67052). ``ok`` stays

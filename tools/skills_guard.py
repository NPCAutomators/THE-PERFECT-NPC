...
Trust levels:
  - builtin:   Ships with Zorin. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.zorin/\.env|\~/\.zorin/\.env',
     "zorin_env_access", "critical", "exfiltration",
     "directly references Zorin secrets file"),
    ...
    (r'\.zorin/config\.yaml|\.zorin/SOUL\.md',
     "zorin_config_mod", "critical", "persistence",
     "references Zorin configuration files directly"),
...
# scan. `.skillignore` is the Zorin-native name; `.clawhubignore` is honored

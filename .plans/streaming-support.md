# Streaming LLM Response Support for ZORIN
...
```
ZORIN_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("ZORIN_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `zorin_cli/config.py` | 1 | +streaming config defaults |

...
Usage:
    zorin pairing list              # Show all pending + approved users
    zorin pairing approve <platform> <code>  # Approve a pairing code
    zorin pairing revoke <platform> <user_id> # Revoke user access
    zorin pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle zorin pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: zorin pairing {list|approve|revoke|clear-pending}")
        print("Run 'zorin pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.zorin/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'zorin pairing list' to see pending codes.\n")

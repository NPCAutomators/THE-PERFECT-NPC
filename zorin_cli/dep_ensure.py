...
def _has_zorin_agent_browser() -> bool:
    ...
    # install.sh installs globally into $ZORIN_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-ZorinHome", str(get_zorin_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = zorin_subprocess_env(inherit_credentials=False)

"""
Single source of truth for provider identity in ZORIN.
...
2. **Zorin overlays** — transport type, auth patterns, aggregator flags,
...
# -- Zorin overlay ----------------------------------------------------------
# Zorin-specific metadata that models.dev doesn't provide.

@dataclass(frozen=True)
class ZorinOverlay:
    """Zorin-specific provider metadata layered on top of models.dev."""
...
ZORIN_OVERLAYS: Dict[str, ZorinOverlay] = {
    "moa": ZorinOverlay(
        transport="openai_chat",
        auth_type="virtual",
        base_url_override="moa://local",
    ),
    "openrouter": ZorinOverlay(
        transport="openai_chat",
        is_aggregator=True,
        base_url_env_var="OPENROUTER_BASE_URL",
    ),
    "npcautomators": ZorinOverlay(
        transport="openai_chat",
        auth_type="oauth_device_code",
        base_url_override="https://inference-api.npcautomators.com/v1",
    ),
    "openai-codex": ZorinOverlay(
        transport="codex_responses",
        auth_type="oauth_external",
        base_url_override="https://chatgpt.com/backend-api/codex",
    ),
    "openai-api": ZorinOverlay(
        transport="codex_responses",
        base_url_override="https://api.openai.com/v1",
        base_url_env_var="OPENAI_BASE_URL",
    ),
    "xai-oauth": ZorinOverlay(
        transport="codex_responses",
        auth_type="oauth_external",
        base_url_override="https://api.x.ai/v1",
        base_url_env_var="XAI_BASE_URL",
    ),
    "qwen-oauth": ZorinOverlay(
        transport="openai_chat",
        auth_type="oauth_external",
        base_url_override="https://portal.qwen.ai/v1",
        base_url_env_var="ZORIN_QWEN_BASE_URL",
    ),
    "lmstudio": ZorinOverlay(
        transport="openai_chat",
        auth_type="api_key",
    ...
    "copilot-acp": ZorinOverlay(
        transport="codex_responses",
        auth_type="external_process",
        base_url_override="acp://copilot",
        base_url_env_var="COPILOT_ACP_BASE_URL",
    ),
    "github-copilot": ZorinOverlay(
        transport="openai_chat",
        extra_env_vars=("COPILOT_GITHUB_TOKEN", "GH_TOKEN"),
    ),
    "anthropic": ZorinOverlay(
    ...
    "kimi-for-coding": ZorinOverlay(
        transport="openai_chat",
        base_url_env_var="KIMI_BASE_URL",
    ),
    "stepfun": ZorinOverlay(
        transport="openai_chat",
        extra_env_vars=("STEPFUN_API_KEY",),
        base_url_override="https://api.stepfun.ai/step_plan/v1",
        base_url_env_var="STEPFUN_BASE_URL",
    ),
    "minimax": ZorinOverlay(
        transport="anthropic_messages",
        base_url_env_var="MINIMAX_BASE_URL",
    ),
    "minimax-oauth": ZorinOverlay(
        transport="anthropic_messages",
        auth_type="oauth_external",
        base_url_override="https://api.minimax.io/anthropic",
    ),
    "minimax-cn": ZorinOverlay(
        transport="anthropic_messages",
        base_url_env_var="MINIMAX_CN_BASE_URL",
    ),
    "deepseek": ZorinOverlay(
        transport="openai_chat",
        base_url_env_var="DEEPSEEK_BASE_URL",
    ),
    "alibaba": ZorinOverlay(
        transport="openai_chat",
        base_url_env_var="DASHSCOPE_BASE_URL",
    ),
    "alibaba-coding-plan": ZorinOverlay(
        transport="openai_chat",
        base_url_env_var="ALIBABA_CODING_PLAN_BASE_URL",
    ),
    "opencode": ZorinOverlay(
        transport="openai_chat",
        is_aggregator=True,
        base_url_env_var="OPENCODE_ZEN_BASE_URL",
    ),
    "opencode-go": ZorinOverlay(
        transport="openai_chat",
        is_aggregator=True,
    ...
    "azure-foundry": ZorinOverlay(
        transport="openai_chat",  # default; overridden by api_mode in config
        base_url_env_var="AZURE_FOUNDRY_BASE_URL",
    ),
    "bedrock": ZorinOverlay(
...
class ProviderDef:
    ...
    doc: str = ""
    source: str = ""                      # "models.dev", "zorin", "user-config"
...
_LABEL_OVERRIDES: Dict[str, str] = {
    ...
    "npcautomators": "NPCAUTOMATORS Portal",
...
def get_provider(name: str) -> Optional[ProviderDef]:
    ...
    Resolution order:
      1. Zorin overlays (for providers not in models.dev: npcautomators, openai-codex, etc.)
      2. models.dev catalog + Zorin overlay
    ...
    overlay = ZORIN_OVERLAYS.get(canonical)
    ...
    if mdev_info is not None:
        ...
        # Combine env vars: models.dev env + zorin extra
    ...
    if overlay is not None:
        # Zorin-only provider (not in models.dev)
        return ProviderDef(
            id=canonical,
...
def determine_api_mode(provider: str, base_url: str = "") -> str:
    ...
    # Direct provider checks for providers not in ZORIN_OVERLAYS
    if provider == "bedrock":
        return "bedrock_converse"
...
def resolve_provider_full(
    ...
    # 0.5 Exact Zorin provider IDs must win over LOSSY alias collapsing.
    ...
    if canonical != raw:
        try:
            from zorin_cli.auth import PROVIDER_REGISTRY as _AUTH_PROVIDER_REGISTRY

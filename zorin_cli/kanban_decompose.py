...
Invoked by ``zorin kanban decompose [task_id | --all]`` and the
...
* Mirrors the shape of ``zorin_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the ZORIN board.
...
def _profile_author() -> str:
    """Mirror of ``zorin_cli.kanban._profile_author``."""
    return (

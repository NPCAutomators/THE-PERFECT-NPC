...
Entry point: ``zorin whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``zorin_cli/main.py``).
...
Zorin gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Zorin to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Zorin needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Zorin gateway in another terminal:")
    print("         zorin gateway")
    print()
    ...
    print()
    print("  Docs: https://github.com/NPCAutomators/AGENT-ZORIN/tree/main/docs/user-guide/")

"""Zorin skin/theme engine — the theme SDK for every surface.

A data-driven skin system that lets users (and Zorin itself) customize the
visual appearance across the CLI, the TUI, and the desktop GUI from a single
file. Skins are defined as YAML files in ~/.zorin/skins/ or as built-in presets.
...
``resolve_skin`` / ``skin.changed``). A skin dropped in ~/.zorin/skins/ therefore
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "ZORIN"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Zorin "       # Response box header label
...
.. code-block:: python
    ...
    from zorin_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#D97757"
    print(skin.get_branding("agent_name"))  # "ZORIN"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.zorin/skins/
...
Drop a YAML file in ``~/.zorin/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces ZORIN_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces ZORIN_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Zorin — warm coral and clean neutrals",
        # Dark-authored. Values match the TUI's DARK_THEME and use the warm
        # coral + neutral hierarchy familiar from Claude Code.
        "colors": {
            "banner_border": "#A16F5D",
            "banner_title": "#D97757",
            "banner_accent": "#E18A6D",
            "banner_dim": "#A39189",
            "banner_text": "#FFFFFF",
            "ui_accent": "#D97757",
            "ui_label": "#D6B2A4",
            ...
            "status_bar_bg": "#211E1D",
            "status_bar_text": "#D8D2CF",
            "status_bar_strong": "#E18A6D",
            "status_bar_dim": "#9B8981",
            "status_bar_good": "#8FBC8F",
            "status_bar_warn": "#E5A46B",
            "status_bar_bad": "#E07A4F",
            "status_bar_critical": "#FF6B6B",
            "session_label": "#D6B2A4",
            "session_border": "#8C756C",
            "completion_menu_bg": "#211E1D",
            "completion_menu_current_bg": "#44342E",
            "selection_bg": "#563A31",
            "shell_dollar": "#4dabf7",
            "voice_status_bg": "#211E1D",
        },
        # Light overlay: the same warm identity with dark ink and light fills.
        "light_colors": {
            "banner_title": "#B24F35",
            "banner_accent": "#B95B40",
            "banner_dim": "#75665F",
            "banner_text": "#2E2927",
            "ui_accent": "#B4533A",
            "ui_label": "#8F503D",
            ...
            "ui_warn": "#9A5B17",
            "prompt": "#B4533A",
            "response_border": "#9B513C",
            "session_label": "#8F503D",
            "status_bar_text": "#5F5956",
            "status_bar_strong": "#9B513C",
            "status_bar_dim": "#766A65",
            "status_bar_good": "#2E7D32",
            "status_bar_warn": "#9A5B17",
            "status_bar_bad": "#B4533A",
            "status_bar_critical": "#B91C1C",
            "shell_dollar": "#1E6FC0",
            "completion_menu_bg": "#F7F3F1",
            "completion_menu_current_bg": "#ECDDD7",
            "selection_bg": "#EAD3CA",
            "status_bar_bg": "#F7F3F1",
            "voice_status_bg": "#F7F3F1",
        },
        "spinner": {
        ...
        "branding": {
            "agent_name": "ZORIN",
            "welcome": "Welcome to ZORIN! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Zorin ",
            "prompt_symbol": "❯",

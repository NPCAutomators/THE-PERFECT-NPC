"""
Skills configuration for ZORIN.
`zorin skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.zorin/config.yaml under:
...
from zorin_cli.config import cfg_get, load_config, save_config
from zorin_cli.colors import Colors, color
from zorin_cli.platforms import PLATFORMS as _PLATFORMS

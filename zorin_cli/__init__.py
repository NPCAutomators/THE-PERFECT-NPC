"""
Zorin CLI - Unified command-line interface for ZORIN.

Provides subcommands for:
- zorin chat          - Interactive chat (same as ./zorin)
- zorin gateway       - Run gateway in foreground
- zorin gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `zorin setup` on a fresh Pi.
    ...
    zorin_cli/stdio.py::configure_windows_stdio() runs later from the entry

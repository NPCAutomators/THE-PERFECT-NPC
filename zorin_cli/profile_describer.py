...
Used by ``zorin profile describe <name> --auto`` and the dashboard's
...
_SYSTEM_PROMPT = """You are a profile-describer for the ZORIN kanban board.
...
Rules:
  ...
  - Never write "ZORIN profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_zorin_home())
        else:

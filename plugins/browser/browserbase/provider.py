...
credentials. Managed NpcAutomators gateway support has been removed — the NpcAutomators
...
class BrowserbaseBrowserProvider(BrowserProvider):
    ...
    Direct credentials only — managed-NpcAutomators-gateway support lives on the

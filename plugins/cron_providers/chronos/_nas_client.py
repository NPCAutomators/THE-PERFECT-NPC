...
existing NPCAUTOMATORS Portal access token (the same token it already uses to call the
...
class NasCronClient:
    ...
    Uses the agent's refresh-aware NpcAutomators access token for auth. No scheduler
    ...
    def _access_token(self) -> str:
        """The agent's existing NPCAUTOMATORS Portal access token (refresh-aware)."""

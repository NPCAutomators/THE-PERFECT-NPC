...
# When the user hasn't picked a reasoning effort, Zorin passes
...
# ON at this effort — matching the "medium (default)" that Zorin' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Zorin' effort vocabulary onto Solar's accepted set. xhigh/max/

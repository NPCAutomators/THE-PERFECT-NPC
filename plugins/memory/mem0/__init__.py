...
Configuration
-------------
Secret (lives in $ZORIN_HOME/.env or the environment):
...
Behavioral settings (live in $ZORIN_HOME/mem0.json, set via `zorin memory
setup`):
  ...
  agent_id           — Agent identifier (default: zorin)
...
def _load_config() -> dict:
    """Load config from env vars, with $ZORIN_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "zorin"),
        "oss": {},
    }
    ...
    config_path = get_zorin_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, zorin_home):
        """Write config to $ZORIN_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $ZORIN_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "zorin")

...
Config: ~/.zorin/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.zorin/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_zorin_home()`` helper (ZORIN_HOME-aware and
...
RULES_FILE = get_zorin_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_zorin_home() / "feishu_comment_pairing.json"

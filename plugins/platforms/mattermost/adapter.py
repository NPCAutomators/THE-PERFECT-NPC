...
required — uses aiohttp which is already a Zorin dependency.
...
def interactive_setup() -> None:
    ...
    ``zorin_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Zorin delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # zorin_cli/setup.py::_setup_mattermost function.

...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Zorin gateway adapter.

    Each inbound phone number gets its own Zorin session (multi-tenant).
...
# static dict in zorin_cli/gateway.py, and the _send_sms dispatch in

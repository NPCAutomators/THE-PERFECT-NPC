...
``_check_spotify_available()`` — when the user has not run ``zorin auth
spotify``, the tools remain registered (so they appear in ``zorin
...
The Spotify auth flow (``zorin auth spotify``), CLI plumbing, and docs

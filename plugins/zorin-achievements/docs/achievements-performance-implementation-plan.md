# Zorin Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.zorin/plugins/zorin-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.zorin/plugins/zorin-achievements/scan_checkpoint.json`.

# Zorin Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.zorin/plugins/zorin-achievements/state.json` (existing unlock state)
  - `~/.zorin/plugins/zorin-achievements/scan_snapshot.json` (new)
  - `~/.zorin/plugins/zorin-achievements/scan_checkpoint.json` (new)

 ...
 * `window.__ZORIN_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Zorin brand in the top bar
 ...
 *  `window.__ZORIN_PLUGINS__.registerSlot(...)`.
 *

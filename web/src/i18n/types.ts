...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateZorin: string;
    updateZorinConfirmMessage?: string;
    updateZorinConfirmNow?: string;
    updateZorinConfirmTitle?: string;
    updatingZorin: string;
  ...
  // ── Achievements plugin (plugins/zorin-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;

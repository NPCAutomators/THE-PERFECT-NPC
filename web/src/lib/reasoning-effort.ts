 ...
 *
 * Values mirror zorin_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Zorin default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Zorin' default when unset). */

...
const STORAGE_KEY = "zorin-dashboard-theme";
...
const FONT_STORAGE_KEY = "zorin-dashboard-font";
...
const THEME_NAME_ALIASES: Record<string, string> = {
  // Renamed during the LENS_5I port + NpcAutomators-blue rebrand.
  "lens-5i": "npcautomators-blue",
};
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `zorin_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "zorin-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-zorin-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-zorin-theme-font", "true");
...
function applyTheme(theme: DashboardTheme) {
  ...
  // (e.g. NpcAutomators Blue) doesn't leave its values behind when the user

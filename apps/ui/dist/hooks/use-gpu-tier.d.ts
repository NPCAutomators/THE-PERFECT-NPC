 ...
 * *after the first paint* (see `scheduleDetection` below), never synchrozorinly
 ...
 *    tier. (A previous version made the probe synchrozorin-at-module-load to
 ...
 *    milliseconds. Running it synchrozorinly at module load stalled first paint
 *    and produced a visible boot-time flash in apps that merely import this
 *    hook (e.g. the Zorin dashboard backdrop). Deferring past first paint

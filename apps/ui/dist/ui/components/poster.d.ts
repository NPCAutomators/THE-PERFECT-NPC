 ...
 *   marks and a tiny "Zorin Agent" mark in the corner — mirrors the
 *   overlay on the Zorin agent website.
...
export interface PosterProps {
    ...
    /**
     * Signature mark. In `vibe` this is the small "Zorin Agent" overlay in the
     * bottom-right. In `dispatch` this is the URL / CTA in the footer.
     */
    signature?: React.ReactNode;
    /** Override the poster image. Defaults to the Zorin "filler-bg0" asset. */
    src?: string;

...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|zorin):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.zorinDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.zorinDesktop?.openExternal?.(href)
  }
}

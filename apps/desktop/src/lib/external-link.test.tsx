...
function installDesktopBridge(partial: Partial<Window['zorinDesktop']> = {}) {
  desktopWindow.zorinDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['zorinDesktop']
}
...
afterEach(() => {
  ...
  if (initialZorinDesktop) {
    desktopWindow.zorinDesktop = initialZorinDesktop
  } else {
    delete desktopWindow.zorinDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['zorinDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['zorinDesktop']['openExternal'] })

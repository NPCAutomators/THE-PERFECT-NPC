...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('zorin:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('zorin:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Zorin to

...
const FOCUS_EVENT = 'zorin:composer-focus'
const INSERT_EVENT = 'zorin:composer-insert'
const INSERT_REFS_EVENT = 'zorin:composer-insert-refs'
const SUBMIT_EVENT = 'zorin:composer-submit'
const VOICE_TOGGLE_EVENT = 'zorin:composer-voice-toggle'

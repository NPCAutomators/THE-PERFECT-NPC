...
export function getNested(obj: ZorinConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: ZorinConfigRecord, path: string, value: unknown): ZorinConfigRecord {
...
function personalityOptions(config: ZorinConfigRecord): string[] {
...
function commandProviderNames(config: ZorinConfigRecord, section: 'tts' | 'stt'): string[] {

...
// over a solid NpcAutomators-blue well and blends into it. This blue well is the ONLY place
// NpcAutomators blue appears in the billing page — everything else stays on the app's own tokens.
const NPCAUTOMATORS_BLUE = '#0000f2'
...
/**
 * Small rounded thumbnail (~40px) rendering the tier art over a NpcAutomators-blue well.
...
export function TierArt({ className, name, size = 40 }: { className?: string; name?: null | string; size?: number }) {
  ...
  return (
    <div
      ...
      style={{ background: NPCAUTOMATORS_BLUE, height: size, width: size }}
    >
      <img
        alt=""

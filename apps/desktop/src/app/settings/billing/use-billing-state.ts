...
export const FALLBACK_PORTAL_BILLING_URL = 'https://portal.npcautomators.com/billing'
export const FALLBACK_PORTAL_URL = 'https://portal.npcautomators.com'
  ...
  if (!billing.logged_in || subscription?.logged_in === false) {
    return {
      notice: {
        ...
        message: 'Run /portal in the TUI or open the NpcAutomators portal to connect your account.',

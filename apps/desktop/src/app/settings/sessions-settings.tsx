...
// / Program Files), which buried any files Zorin wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.zorinDesktop` is
    ...
    const settings = window.zorinDesktop?.settings

...
// Zorin session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
export function CommandPalette() {
      ...
      ...branchGroup,
      {
        ...
        items: [
          ...
          },
          {
            icon: Download,
            id: 'cc-update-zorin',
            keywords: ['update', 'upgrade', 'zorin', 'version', 'system', 'restart'],
            label: cc.updateZorin,
  ...
  const searchGroups = useMemo<PaletteGroup[]>(() => {
    ...
    // Apply a theme directly from the root search (e.g. "npcautomators" → NpcAutomators). Live

...
// hairline `--stroke-npcautomators` paired with the soft `--shadow-npcautomators` float.
...
export const HUD_SURFACE =
  'rounded-xl border border-(--stroke-npcautomators) bg-(--ui-chat-bubble-background) shadow-npcautomators [-webkit-app-region:no-drag]'

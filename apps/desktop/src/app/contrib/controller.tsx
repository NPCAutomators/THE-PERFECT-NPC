...
registry.registerMany([
  ...
  // The agent's write -> see loop: rescan <zorin home>/desktop-plugins
  ...
  // The keybind panel's non-titlebar door (the keyboard icon is gone).
  {
    ...
    data: {
      ...
      run: () => window.dispatchEvent(new CustomEvent('zorin:open-keybinds'))
    } satisfies PaletteContribution
  }
])
...
const $logsOpen = persistentAtom('zorin.desktop.logsOpen', false, Codecs.bool)

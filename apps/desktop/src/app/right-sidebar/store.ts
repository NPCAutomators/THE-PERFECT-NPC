...
const TAKEOVER_KEY = 'zorin.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Zorin can't clear via the API — the user
 *  sees exactly what runs instead of Zorin silently deleting their creds. */

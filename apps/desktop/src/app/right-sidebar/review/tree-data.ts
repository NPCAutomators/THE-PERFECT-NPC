...
export function buildReviewFlatList(files: ZorinReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: ZorinReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')

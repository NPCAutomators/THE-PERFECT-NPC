...
const PROVIDER_DISPLAY: Record<string, { order: number; title: string }> = {
  npcautomators: { order: 0, title: 'NPCAUTOMATORS Portal' },
...
export function FeaturedProviderRow({
  ...
  return (
    <button
      ...
      type="button"
    >
      <span aria-hidden className="arc-border arc-reverse arc-npcautomators" />
...
/** Quick-key row for API-key providers (Fireworks #2 after NpcAutomators, OpenRouter further down). */

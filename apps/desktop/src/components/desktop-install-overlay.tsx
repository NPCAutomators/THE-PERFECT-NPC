 ...
 *
 * Renders the first-launch install progress for ZORIN. Mounted always;
...
export function DesktopInstallOverlay({ enabled = true }: DesktopInstallOverlayProps) {
  ...
  // there's no ZORIN installed yet and we can't drive install.sh
  ...
  if (state.unsupportedPlatform) {
    ...
    return (
      <div className="fixed inset-0 z-[1400] flex items-center justify-center bg-background/90 backdrop-blur-md">
        <div className="w-full max-w-xl rounded-xl border border-(--stroke-npcautomators) bg-card p-8 shadow-npcautomators">
          ...
          <div className="mt-4">
            ...
            <pre className="overflow-x-auto rounded-md border border-(--stroke-npcautomators) px-3 py-2.5 font-mono text-[12px]">
            ...
            <div className="mt-2 flex items-center gap-2">
              ...
              <Button
                onClick={() => {
                  window.zorinDesktop?.openExternal?.(ups.docsUrl)
                }}
                size="sm"
                variant="ghost"
              >
  ...
  return (
    <div className="fixed inset-0 z-[1400] flex items-center justify-center bg-background/90 backdrop-blur-md p-4">
      <div className="flex w-full max-w-2xl max-h-[90vh] flex-col rounded-xl border border-(--stroke-npcautomators) bg-card shadow-npcautomators">
            ...
            <div className="flex items-center justify-end">
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    await window.zorinDesktop?.cancelBootstrap?.()
                  } catch {
          ...
          <div className="flex-shrink-0 bg-card p-4">
            <div className="flex items-center justify-between gap-2">
              <span className="text-xs text-muted-foreground">
                ...
                <code className="font-mono text-(--ui-text-secondary)">%LOCALAPPDATA%\zorin\logs\</code>
              </span>
              <div className="flex gap-2">
                ...
                <Button
                  onClick={async () => {
                    ...
                    try {
                      await window.zorinDesktop?.resetBootstrap?.()
                    } catch {

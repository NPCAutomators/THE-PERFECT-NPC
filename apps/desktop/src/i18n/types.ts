...
export interface Translations {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshZorinPathTitle: string
      sshZorinPathDesc: string
      sshZorinPathPlaceholder: string
    ...
    toolsets: {
      ...
      needsSignIn: string
      needsSetup: string
      npcAutomatorsIncluded: string
      npcAutomatorsAuthNeededTitle: string
      npcAutomatorsAuthNeededMessage: (provider: string) => string
      npcAutomatorsAuthSignIn: string
      npcAutomatorsAuthDoneTitle: string
      npcAutomatorsAuthDoneMessage: string
      npcAutomatorsAuthFailed: string
  ...
  commandCenter: {
    ...
    zorinActiveSessions: (version: string, count: number) => string

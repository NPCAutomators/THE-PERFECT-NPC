...
export const en: Translations = {
  ...
  boot: {
    ready: 'Zorin Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Zorin settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingZorinDesktop: 'Starting Zorin Desktop…'
    },
    errors: {
      backgroundExited: 'Zorin background process exited.',
      backgroundExitedDuringStartup: 'Zorin background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Zorin backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateZorin: 'Update Zorin',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Zorin Desktop.',
    ...
    native: {
      ...
      inputBody: 'Zorin is waiting for your response.',
      turnDoneTitle: 'Zorin finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Zorin defaults?',
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones Zorin writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Zorin is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Zorin asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Zorin was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Zorin follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Zorin is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Zorin, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Zorin checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Zorin configuration...',
    ...
    gateway: {
      ...
      intro:
        'Zorin Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Zorin backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset ZORIN_DESKTOP_REMOTE_URL and ZORIN_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Zorin backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Zorin backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Zorin Cloud',
      cloudDesc: 'Sign in once to Zorin Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Zorin Cloud',
      cloudSignIn: 'Sign in to Zorin Cloud',
      cloudSignedIn: 'Signed in to Zorin Cloud',
      cloudNeedsSignIn: 'Sign in to Zorin Cloud to discover the agents on your account.',
      ...
      cloudNoAgents: {
        ...
        linkText: 'NpcAutomators portal',
        after: ', then refresh.'
      },
      cloudRefresh: 'Refresh',
      cloudConnect: 'Connect',
      cloudConnecting: 'Connecting…',
      cloudDiscoverFailed: 'Could not load your Zorin Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Zorin Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Zorin Cloud',
      cloudSignedOutMessage: 'Cleared the Zorin Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /zorin.',
      ...
      restartingMessage: 'Zorin Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Zorin ${version}` : ''}`,
      ...
      sshDesc:
        'Zorin is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshZorinPathTitle: 'Zorin path (optional)',
      sshZorinPathDesc: 'Full path to the remote zorin binary. Blank = auto-detect.',
      sshZorinPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Zorin found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Zorin runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Zorin is not installed on the remote host. Install it there (curl -fsSL https://raw.githubusercontent.com/NPCAutomators/AGENT-ZORIN/main/scripts/install.sh | sh) or set the Zorin path.',
      sshErrPlatform:
        'Unsupported remote platform. Zorin Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Zorin on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Zorin runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Zorin at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      npcAutomatorsIncluded: 'Included with a NPCAUTOMATORS subscription — sign in to NPCAUTOMATORS Portal to activate.',
      npcAutomatorsAuthNeededTitle: 'Sign in to NPCAUTOMATORS Portal',
      npcAutomatorsAuthNeededMessage: provider => `${provider} is saved but won't activate until you sign in to NPCAUTOMATORS Portal.`,
      npcAutomatorsAuthSignIn: 'Sign in',
      npcAutomatorsAuthDoneTitle: 'NPCAUTOMATORS Portal connected',
      npcAutomatorsAuthDoneMessage: 'Your subscription backends are now active.',
      npcAutomatorsAuthFailed: 'NPCAUTOMATORS Portal sign-in did not complete',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via zorin curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Zorin builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Zorin to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Zorin to generate pets.',
      backgroundHint: 'You can close this — Zorin will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Zorin desktop' },
    ...
    zorinActiveSessions: (version, count) => `Zorin ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@zorin:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Zorin environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Zorin will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Zorin backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Zorin. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Zorin...',
    placeholderReconnecting: 'Reconnecting to Zorin…',
    ...
    attachUrlDesc: 'Zorin will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Zorin to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Zorin…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Zorin…',
    ...
    unsupportedMessage: 'This version of Zorin can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Zorin from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Zorin will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Zorin desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Zorin updater takes over in its own window and reopens Zorin automatically when it’s done. Please don’t reopen Zorin yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Zorin reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Zorin reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Zorin needs a one-time install',
    ...
    settingUpTitle: 'Setting up ZORIN',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Zorin CLI or desktop instance is running. Stop any running Zorin instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with ZORIN",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Zorin is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Zorin…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Zorin',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Zorin at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Zorin connects automatically',
    ...
    authorizeThere: 'Authorize Zorin there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Zorin there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid NPCAUTOMATORS subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Zorin Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Connected to Zorin Cloud at ${host} · click to manage`,
      ...
      gatewayTitle: 'Zorin inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Zorin will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Zorin is restarting...',
      askRestart: 'Ask Zorin to restart the server',
      lookingRestart: taskId => `Zorin is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Zorin is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Zorin finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Zorin could not restart the server.',
      stillWorking:
        'Zorin is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Zorin is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Zorin gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.zorin/config.yaml). Zorin won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Zorin needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Zorin needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Zorin Desktop to use Save Image.',
    restartToSaveImages: 'Restart Zorin Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `zorin gateway` running?'
    }
  },

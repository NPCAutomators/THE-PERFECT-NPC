 ...
 * plugins resolve `@zorin/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __ZORIN_PLUGIN_SDK__: sdk,
  __ZORIN_REACT__: React,
  __ZORIN_REACT_JSX__: jsxRuntime,
  __ZORIN_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@zorin/plugin-sdk': shimUrl('__ZORIN_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__ZORIN_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__ZORIN_REACT_JSX__'),
    react: shimUrl('__ZORIN_REACT__')
  }

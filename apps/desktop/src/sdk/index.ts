/**
 * @zorin/plugin-sdk — THE plugin language. The vscode-module model: plugin
 ...
 *    object as `window.__ZORIN_PLUGIN_SDK__` and maps the import to it, so a
...
export type { RpcEvent, StatusResponse } from '@/types/zorin'

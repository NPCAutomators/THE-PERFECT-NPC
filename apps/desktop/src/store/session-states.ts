...
const TILES_KEY = 'zorin.desktop.sessionTiles.v2'
const LEGACY_TILES_KEY = 'zorin.desktop.sessionTiles.v1'
...
// Dev hook for automation (mirrors __ZORIN_LAYOUT_TREE__).
if (import.meta.env.DEV && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__ZORIN_SESSION_TILES__ = {

...
export interface PetInfo {
  ...
  // the Zorin "run" activity state uses the in-place running row).
 ...
 * ZORIN_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'zorin.desktop.pet-roam.v1'

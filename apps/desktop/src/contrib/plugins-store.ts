 ...
 * `<zorin home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'zorin.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'zorin.desktop.disabledPlugins.v1'

/**
 * Zorin skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$ZORIN_HOME/skins/` (or a
 * built-in) resolved by `zorin_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Zorin authors from a prompt lights up all three surfaces from one file.
 *
 ...
 */
export function skinToDesktopTheme(skin: ZorinSkin): DesktopTheme | null {

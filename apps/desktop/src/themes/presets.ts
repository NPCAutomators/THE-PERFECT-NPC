...
const NPCAUTOMATORS_BLUE = '#0053FD'
const PSYCHE_BLUE = '#1540B1'
const PSYCHE_WARM = '#FFE6CB'

const npcAutomatorsTint = (pct: number) => `color-mix(in srgb, ${NPCAUTOMATORS_BLUE} ${pct}%, #FFFFFF)`
const npcAutomatorsTintTransparent = (pct: number) => `color-mix(in srgb, ${NPCAUTOMATORS_BLUE} ${pct}%, transparent)`

/**
 * NpcAutomators — canonical Zorin desktop identity. The palette keeps the current
 * glass geometry neutral, then lets the old bb/gui blue and psyche cream
 * return as accent seeds.
 */
export const npcAutomatorsTheme: DesktopTheme = {
  name: 'npcautomators',
  label: 'NpcAutomators',
  description: 'Glass neutrals with NpcAutomators blue accents',
  colors: {
    background: '#F8FAFF',
    foreground: '#17171A',
    card: '#FFFFFF',
    cardForeground: '#17171A',
    muted: npcAutomatorsTint(5),
    mutedForeground: '#666678',
    popover: '#FFFFFF',
    popoverForeground: '#17171A',
    primary: NPCAUTOMATORS_BLUE,
    primaryForeground: '#FCFCFC',
    secondary: npcAutomatorsTint(7),
    secondaryForeground: '#242432',
    accent: npcAutomatorsTint(10),
    accentForeground: '#202030',
    border: npcAutomatorsTintTransparent(22),
    input: npcAutomatorsTintTransparent(30),
    ring: NPCAUTOMATORS_BLUE,
    midground: NPCAUTOMATORS_BLUE,
    composerRing: NPCAUTOMATORS_BLUE,
    destructive: '#C72E4D',
    destructiveForeground: '#FFFFFF',
    sidebarBackground: '#F3F7FF',
    sidebarBorder: npcAutomatorsTintTransparent(18),
    userBubble: npcAutomatorsTint(6),
    userBubbleBorder: npcAutomatorsTintTransparent(24)
  },
  darkColors: {
    background: '#0D2F86',
...
export const BUILTIN_THEMES: Record<string, DesktopTheme> = {
  npcautomators: npcAutomatorsTheme,
...
export const DEFAULT_SKIN_NAME = 'npcautomators'

...
// even though a fresh shell — and the Zorin CLI — sees it immediately. The
// desktop's ZORIN_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\zorin. Reading
...
//       ZORIN_HOME    REG_SZ    F:\Zorin\data
//

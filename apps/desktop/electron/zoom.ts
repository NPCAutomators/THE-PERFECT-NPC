...
export const ZOOM_STORAGE_KEY = 'zorin:desktop:zoomLevel'
 ...
 * but forgot to emit 'zorin:zoom:changed', leaving the control stuck at 100%.
...
export function applyZoomLevel(webContents, level) {
  ...
  webContents.send('zorin:zoom:changed', { level: clamped, percent: zoomLevelToPercent(clamped) })

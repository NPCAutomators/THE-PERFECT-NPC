 ...
 * Apps) login to a gated Zorin gateway: system-browser + loopback redirect +
 ...
 * upstream IDP (NPCAUTOMATORS Portal) issues a per-gateway-instance client_id and only
...
// zorin_cli/web_server.py status handler.

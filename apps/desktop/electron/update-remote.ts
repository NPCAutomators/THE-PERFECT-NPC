 ...
 *
 * A public install can end up with `origin=git@github.com:NPCAutomators/AGENT-ZORIN.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/NPCAutomators/AGENT-ZORIN.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/npcautomators/agent-zorin'

...
/**
 * E2E smoke tests for the packaged Zorin desktop app.
 *
 ...
 * (credential stripping, isolated ZORIN_HOME + userData, unique app name).
 *
...
test('window opens with the Zorin title', async () => {

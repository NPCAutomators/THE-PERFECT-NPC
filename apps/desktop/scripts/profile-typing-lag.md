...
cd apps/desktop
XCURSOR_SIZE=24 ZORIN_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/zorin-typing
# → /tmp/zorin-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/zorin-typing.before.heapsnapshot
# → /tmp/zorin-typing.after.heapsnapshot
```

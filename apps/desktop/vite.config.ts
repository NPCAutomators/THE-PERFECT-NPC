...
export default defineConfig({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\zorin\zorin-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@zorin/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@zorin/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@zorin/shared': path.resolve(__dirname, '../shared/src'),

/**
 * Canonical Zorin skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$ZORIN_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`zorin_cli/skin_engine.py`),
 ...
 *   • CLI     → `zorin_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *

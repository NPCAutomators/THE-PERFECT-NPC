import type { UsageModelData } from '@zorin/shared/billing'
import type { ZorinSkin } from '@zorin/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@zorin/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = ZorinSkin
...
// Wire shapes now live in @zorin/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingCardInfo,

...
import { Box, type ScrollBoxHandle, stringWidth, Text } from '@zorin/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (ZORIN_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (ZORIN_DEV_CREDITS), lowest priority,

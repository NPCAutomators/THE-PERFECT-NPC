 ...
 *
 * Symptom: in `zorin --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@zorin/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using zorin --tui and as i type multiline my caret at the end will often ' +

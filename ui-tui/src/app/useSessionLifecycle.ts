...
import type { ScrollBoxHandle } from '@zorin/ink'
import { evictInkCaches } from '@zorin/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ZORIN_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }

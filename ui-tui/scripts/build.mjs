...
await build({
  ...
  // Skip the prebuilt @zorin/ink bundle and inline the source instead:
  ...
  alias: { '@zorin/ink': resolve(root, 'packages/zorin-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The zorin_cli launcher

 ...
 * across theme x background scenes to <tmpdir>/zorin-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@zorin/ink'
...
const setup = (bgHex: string) => {
  process.env.ZORIN_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}

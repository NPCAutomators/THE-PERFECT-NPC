...
$RepoUrlSsh = "git@github.com:NPCAutomators/AGENT-ZORIN.git"
$RepoUrlHttps = "https://github.com/NPCAutomators/AGENT-ZORIN.git"
$PythonVersion = "3.11"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/NPCAutomators/AGENT-ZORIN/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/NPCAutomators/AGENT-ZORIN/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/NPCAutomators/AGENT-ZORIN/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/NPCAutomators/AGENT-ZORIN/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow

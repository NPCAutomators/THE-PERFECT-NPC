...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Zorin\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "noreply@github.com",
    "noreply@npcautomators.com",
    "cursoragent@cursor.com",
    "zorin@npcautomators.com",
    "zorin-audit@example.com",
    "nousbot@npcautomators.com",
    "zorin@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "NPCAutomators/AGENT-ZORIN",
                "--state", "merged",

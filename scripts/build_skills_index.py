#!/usr/bin/env python3
"""Build the Zorin Skills Index — a centralized JSON catalog of all skills.
...
`zorin skills search/install` can use it without hitting the GitHub API.
...
# Ensure ZORIN_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Zorin Skills Index...", flush=True)

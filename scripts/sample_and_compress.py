...
DEFAULT_DATASETS = [
    "NPCAutomators/swe-terminus-agent-glm-kimi-minimax",
    "NPCAutomators/zorin-agent-megascience-sft1",
    "NPCAutomators/Zorin-Agent-Thinking-GLM-4.7-SFT2",
    "NPCAutomators/Zorin-Agent-Thinking-GLM-4.7-SFT1",
    "NPCAutomators/terminal-tasks-glm-zorin-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "NPCAutomators/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload NPCAutomators/{output_name} {final_output}")

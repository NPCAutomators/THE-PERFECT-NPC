...
def _profile_user_agent() -> str:
    """Return a ``zorin-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from zorin_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"zorin-cli/{_ver}"
    except Exception:
        return "zorin-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # zorin-cli UA so the catalog endpoint is reachable.
